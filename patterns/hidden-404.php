...
<div class="wp-block-group alignwide" style="margin-top:5px">
	...
	<!-- wp:search {"label":"<?php echo esc_html_x( 'Suche', 'Beschriftung', 'wp-fire' ); ?>","placeholder":"<?php echo esc_attr_x( 'Suche...', 'Platzhalter für das Suchfeld', 'wp-fire' ); ?>","showLabel":false,"width":100,"widthUnit":"%","buttonText":"<?php esc_attr_e( 'Suche', 'wp-fire' ); ?>","buttonUseIcon":true,"align":"center"} /-->
</div>
<!-- /wp:group -->
