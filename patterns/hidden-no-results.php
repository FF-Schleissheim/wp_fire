...
<!-- wp:search {"label":"<?php echo esc_html_x( 'Suche', 'Beschriftung', 'wp-fire' ); ?>","placeholder":"<?php echo esc_attr_x( 'Suche...', 'Platzhalter für das Suchfeld', 'wp-fire' ); ?>","showLabel":false,"buttonText":"<?php esc_attr_e( 'Suche', 'wp-fire' ); ?>","buttonUseIcon":true} /-->
